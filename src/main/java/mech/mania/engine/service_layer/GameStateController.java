...
import mech.mania.engine.domain.communication.player.PlayerRequestSender;
...
import mech.mania.engine.domain.communication.visualizer.VisualizerBinaryWebSocketHandler;
import mech.mania.engine.domain.model.VisualizerProtos.VisualizerChange;
import mech.mania.engine.adapters.DatabaseFake;
import mech.mania.engine.adapters.Database;
...
public class GameStateController {
    ...
    public static GameState sendPlayerRequestsAndUpdateGameState() {
        ...
        Map<String, PlayerDecision> successfulRequests = PlayerRequestSender.sendPlayerRequestsAndUpdateGameState();
        GameState updatedGameState = GameLogic.doTurn(getCurrentGameState(), successfulRequests);
