...
public class findEnemiesTest {
    ...
    public void setup() {
        ...
        gameState.addNewMonster(0, 0, 0, 0, 0, 0, 0, 0, new Position(10, 10, "pvp"));
    ...
    public void testFindEnemiesPlayer1() {
        ...
        ans.add(new Position(10, 10, "pvp"));
    ...
    public void testFindEnemiesPlayer2() {
        ...
        for (int i = 0; i < enemies.size(); i++) {
            System.out.println(enemies.get(i).getPosition().getX() + "," + enemies.get(i).getPosition().getY());
            assertEquals(enemies.get(i).getPosition(), ans.get(i));
        }
    }
